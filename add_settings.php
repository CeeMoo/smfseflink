...
add_integration_function('integrate_pre_include', '$sourcedir/SimpleSEF.php');
pre_install_check();
...
function pre_install_check()
{
	...
	if (version_compare(PHP_VERSION, '5.0.0', '<'))
		fatal_error('<b>PHP 5 or geater is required to install SimpleSEF.  Please advise your host that PHP4 is no longer maintained and ask that they upgrade you to PHP5.</b><br />');
